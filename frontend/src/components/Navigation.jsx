    ...
    <nav className="fixed top-8 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-[1100px]">
      <div className="nav-glass rounded-full px-8 py-4 flex items-center justify-between shadow-2xl">
        ...
        <a 
          ...
          className="bg-cta-button hover:bg-cta-button/90 text-white text-[10px] font-bold uppercase tracking-[0.15em] px-7 py-2.5 rounded-full transition-all border border-border-main btn-glow-hover"
        >
          Book A Call
        </a>
      </div>
